...
export default function TestNi(){
    ...
    return (
         <div style={{width:810, margin:'0 auto'}}>
            ...
            <div style={{width:400,height:400, display:"inline-block",textAlign:'center', border:"solid 1px #333"}}>
                <br/>
                <img ref={c1u1} style={{width:120, display:'inline-block', border:"solid 1px #333"}} src="cards/blank.png"/>
                <img ref={c2u1} style={{width:120, display:'inline-block', border:"solid 1px #333"}} src="cards/blank.png"/>
                <img ref={c3u1} style={{width:120, display:'inline-block', border:"solid 1px #333"}} src="cards/blank.png"/>
                <br/>
                <h1>Player 1: {playerScore[0]}</h1>
            </div>
            <div style={{width:400,height:400, display:"inline-block",textAlign:'center', border:"solid 1px #333"}}>
            <br/>
                <img ref={c1u2} style={{width:120, display:'inline-block', border:"solid 1px #333"}} src="cards/blank.png"/>
                <img ref={c2u2} style={{width:120, display:'inline-block', border:"solid 1px #333"}} src="cards/blank.png"/>
                <img ref={c3u2} style={{width:120, display:'inline-block', border:"solid 1px #333"}} src="cards/blank.png"/>
                <br/>
                <h1>Player 2: {playerScore[1]}</h1>
            </div>
            <Button variant="contained" sx={{margin:'1%', width: '98%'}} onClick={()=>{setHalt(false);
